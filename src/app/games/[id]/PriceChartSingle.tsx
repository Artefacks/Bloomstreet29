...
export function PriceChartSingle({ symbol, displayPrice, refreshTrigger }: { symbol: string; displayPrice?: number | null; refreshTrigger?: number }) {
  ...
  // Prix affiché : displayPrice (synchro carnet d'ordre) ou stats.last
  const priceToShow = displayPrice ?? stats?.last ?? 0;
        ...
        {stats && (
          <div className="flex items-center gap-3">
            <span className="font-mono text-lg font-semibold text-slate-800 tabular-nums">
              {priceToShow.toLocaleString("fr-FR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
            </span>
